 ...
 * Индексация с нуля: первый элемент — индекс 0.
 */
...
window.NOIR_BASE_PRODUCTS = new Array(
    ...
    { id: "pants-3", name: "Джинсы Классика 80-х", category: "bottom", image: "../images/pants3.png", price: 3290, styles: new Array("y2k", "punk"), rating: 4.5, imageScale: 0.84, imageOffsetY: "1%" },
    ...
    { id: "shoes-3", name: "Берцы Классика двора", category: "shoes", image: "../images/shoes3.png", price: 3190, styles: new Array("rock", "grunge", "punk"), rating: 4.6, imageScale: 0.9, imageOffsetY: "4%" },
